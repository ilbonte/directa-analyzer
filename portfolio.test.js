...
describe('alignMovementDates', () => {
    ...
    it('should align movements with portfolio dates', () => {
        ...
        expect(aligned).toEqual([
            {date: '04/01/2023', value: 500, "matchedType": "liquidità", originalDate: '02/01/2023'},
            {date: '07/01/2023', value: 200, "matchedType": "liquidità", originalDate: '05/01/2023'},
            {
                date: "10/01/2023",
                matchedType: "none",
                originalDate: "10/01/2023",
                value: 1000,
            }
        ]);
    });
